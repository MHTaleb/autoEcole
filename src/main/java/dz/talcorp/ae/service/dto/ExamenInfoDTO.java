...
public class ExamenInfoDTO implements Serializable {
    ...
    private String examenDateExamen;
    ...
    public String getExamenDateExamen() {
        return examenDateExamen;
    }

    public void setExamenDateExamen(String examenDateExamen) {
        this.examenDateExamen = examenDateExamen;
    }
