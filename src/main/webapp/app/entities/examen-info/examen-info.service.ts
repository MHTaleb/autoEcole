...
export class ExamenInfoService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/examen-infos';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IExamenInfo[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
