...
export class ExaminateurService {
    ...
    public resourceSearchUrl = SERVER_API_URL + 'api/_search/examinateurs';
    ...
    search(req?: any): Observable<EntityArrayResponseType> {
        const options = createRequestOption(req);
        return this.http.get<IExaminateur[]>(this.resourceSearchUrl, { params: options, observe: 'response' });
    }
}
