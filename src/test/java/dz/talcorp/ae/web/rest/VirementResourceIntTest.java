...
public class VirementResourceIntTest {
    ...
    private static final Instant DEFAULT_DATE_VIREMENT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_VIREMENT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
