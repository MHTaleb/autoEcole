...
public class LessonResourceIntTest {
    ...
    private static final Instant DEFAULT_DATE_LESSON = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_LESSON = Instant.now().truncatedTo(ChronoUnit.MILLIS);
