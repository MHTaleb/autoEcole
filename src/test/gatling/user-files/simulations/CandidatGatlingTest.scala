 ...
 */
class CandidatGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Candidat entity")
        ...
        .pause(10)
        .repeat(2) {
            exec(http("Get all candidats")
            .get("/api/candidats")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new candidat")
            .post("/api/candidats")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created candidat")
                .get("${new_candidat_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created candidat")
            .delete("${new_candidat_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
