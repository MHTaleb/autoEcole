...
describe('Lesson e2e test', () => {
    ...
    it('should load Lessons', async () => {
        ...
        expect(await lessonComponentsPage.getTitle()).to.eq('autoEcoleV01App.lesson.home.title');
    });
    ...
    it('should load create Lesson page', async () => {
        ...
        expect(await lessonUpdatePage.getPageTitle()).to.eq('autoEcoleV01App.lesson.home.createOrEditLabel');
    ...
    /* it('should create and save Lessons', async () => {
        ...
        await promise.all([
            ...
            lessonUpdatePage.setDateLessonInput('01/01/2001' + protractor.Key.TAB + '02:30AM'),
        ...
        expect(await lessonUpdatePage.getDateLessonInput()).to.contain('2001-01-01T02:30');
    ...
    /* it('should delete last Lesson', async () => {
        ...
        expect(await lessonDeleteDialog.getDialogTitle())
            .to.eq('autoEcoleV01App.lesson.delete.question');
