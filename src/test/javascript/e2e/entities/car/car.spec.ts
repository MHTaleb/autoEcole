...
describe('Car e2e test', () => {
    ...
    it('should load Cars', async () => {
        ...
        expect(await carComponentsPage.getTitle()).to.eq('autoEcoleV01App.car.home.title');
    });

    it('should load create Car page', async () => {
        await carComponentsPage.clickOnCreateButton();
        carUpdatePage = new CarUpdatePage();
        expect(await carUpdatePage.getPageTitle()).to.eq('autoEcoleV01App.car.home.createOrEditLabel');
    ...
    it('should delete last Car', async () => {
        ...
        expect(await carDeleteDialog.getDialogTitle()).to.eq('autoEcoleV01App.car.delete.question');
