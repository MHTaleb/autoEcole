...
describe('Entraineur e2e test', () => {
    ...
    it('should load Entraineurs', async () => {
        ...
        expect(await entraineurComponentsPage.getTitle()).to.eq('autoEcoleV01App.entraineur.home.title');
    });
    ...
    it('should load create Entraineur page', async () => {
        ...
        expect(await entraineurUpdatePage.getPageTitle()).to.eq('autoEcoleV01App.entraineur.home.createOrEditLabel');
    ...
    it('should delete last Entraineur', async () => {
        ...
        expect(await entraineurDeleteDialog.getDialogTitle()).to.eq('autoEcoleV01App.entraineur.delete.question');
