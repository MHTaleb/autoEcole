...
describe('Examinateur e2e test', () => {
    ...
    it('should load Examinateurs', async () => {
        ...
        expect(await examinateurComponentsPage.getTitle()).to.eq('autoEcoleApp.examinateur.home.title');
    });
    ...
    it('should load create Examinateur page', async () => {
        ...
        expect(await examinateurUpdatePage.getPageTitle()).to.eq('autoEcoleApp.examinateur.home.createOrEditLabel');
    ...
    it('should delete last Examinateur', async () => {
        ...
        expect(await examinateurDeleteDialog.getDialogTitle()).to.eq('autoEcoleApp.examinateur.delete.question');
