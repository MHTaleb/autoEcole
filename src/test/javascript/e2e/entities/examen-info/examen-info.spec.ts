...
describe('ExamenInfo e2e test', () => {
    ...
    it('should load ExamenInfos', async () => {
        ...
        expect(await examenInfoComponentsPage.getTitle()).to.eq('autoEcoleV01App.examenInfo.home.title');
    });
    ...
    it('should load create ExamenInfo page', async () => {
        ...
        expect(await examenInfoUpdatePage.getPageTitle()).to.eq('autoEcoleV01App.examenInfo.home.createOrEditLabel');
    ...
    /* it('should delete last ExamenInfo', async () => {
        ...
        expect(await examenInfoDeleteDialog.getDialogTitle())
            .to.eq('autoEcoleV01App.examenInfo.delete.question');
