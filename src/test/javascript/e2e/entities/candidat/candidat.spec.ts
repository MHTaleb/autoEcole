...
describe('Candidat e2e test', () => {
    ...
    it('should load Candidats', async () => {
        ...
        expect(await candidatComponentsPage.getTitle()).to.eq('autoEcoleV01App.candidat.home.title');
    });
    ...
    it('should load create Candidat page', async () => {
        ...
        expect(await candidatUpdatePage.getPageTitle()).to.eq('autoEcoleV01App.candidat.home.createOrEditLabel');
    ...
    it('should delete last Candidat', async () => {
        ...
        expect(await candidatDeleteDialog.getDialogTitle()).to.eq('autoEcoleV01App.candidat.delete.question');
