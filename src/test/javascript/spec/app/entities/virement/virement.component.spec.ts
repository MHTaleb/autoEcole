...
import { VirementComponent } from 'app/entities/virement/virement.component';
...
describe('Component Tests', () => {
    describe('Virement Management Component', () => {
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.virements[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
