...
describe('Service Tests', () => {
    describe('Examen Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Examen(0, currentDate);
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Examen', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        dateExamen: currentDate.format(DATE_FORMAT)
            ...
            it('should update a Examen', async () => {
                const returnedFromService = Object.assign(
                    {
                        dateExamen: currentDate.format(DATE_FORMAT)
                    },
            ...
            it('should return a list of Examen', async () => {
                const returnedFromService = Object.assign(
                    {
                        dateExamen: currentDate.format(DATE_FORMAT)
                    },
            ...
            it('should delete a Examen', async () => {
