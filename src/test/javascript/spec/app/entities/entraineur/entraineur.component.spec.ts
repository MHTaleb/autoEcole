...
import { EntraineurComponent } from 'app/entities/entraineur/entraineur.component';
    ...
    describe('Entraineur Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EntraineurComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.entraineurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
