...
import { ExaminateurComponent } from 'app/entities/examinateur/examinateur.component';
...
describe('Component Tests', () => {
    describe('Examinateur Management Component', () => {
        let comp: ExaminateurComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ExaminateurComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.examinateurs[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
